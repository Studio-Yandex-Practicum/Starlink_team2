...
По нажатию на клавишу "Зарегестрироваться" появится сообщение с просьбой указать рабочую почту. После ввода рабочей почты будет проведена проверка есть ли эта почта в Базе данных рабочих почт, если почты нет, то пользватель может продложить работаь с ботом, как Гость.
После прохождении регистрации пользователю открывается Reply меню (Кнопки добавляет администратор системы через административную панель), согласно его уровню роли (роль устанавливает администратор системы через административную панель). 
![reply](images/reply.png)
По нажатию на кнопку, отправляется информацию и открывается inline клавиатура в которой кнопки отображаются согласно уровню пользователя.
![inline](images/inline.png)
По нажатию на каждую кнопку пользователю отправляется информационное сообщение, которое может в себя включать текст и картинку.
